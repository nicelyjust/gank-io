 ...
 *  @创建者:   lz
 *  @创建时间:  2017/8/27 16:03
 *  @修改时间:  nicely 2017/8/27 16:03
 *  @描述：    日志工具类
 */
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && UiUtils.getApp().getExternalCacheDir() != null)
                defaultDir = UiUtils.getApp().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = UiUtils.getApp().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
