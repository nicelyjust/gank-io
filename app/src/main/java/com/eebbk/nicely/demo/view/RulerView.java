 ...
 *  @文件名:   RulerView
 *  @创建者:   lz
 *  @创建时间:  2017/10/30 16:59
 *  @修改时间:  Administrator 2017/10/30 16:59 
 *  @描述：    TODO
 */
public class RulerView extends View{
    ...
    public RulerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            initValue = a.getInteger(R.styleable.RulerView_init_value, 30);
            gapWidth = a.getDimensionPixelOffset(R.styleable.RulerView_gap_width, 35);
            numberMarginTop = a.getDimensionPixelOffset(R.styleable.RulerView_number_margin_top, 80);
            tapeHeight = a.getDimensionPixelOffset(R.styleable.RulerView_tape_height, 60);
            tapeColor = a.getColor(R.styleable.RulerView_tape_color, Color.parseColor("#E6E8E5"));
            indicatorColor = a.getColor(R.styleable.RulerView_indicator_color, Color.parseColor("#6DB67C"));
            numberColor = a.getColor(R.styleable.RulerView_number_color, Color.parseColor("#555855"));
            numberSize = a.getDimensionPixelOffset(R.styleable.RulerView_number_size, 48);
            indicatorWidth = a.getDimensionPixelOffset(R.styleable.RulerView_indicator_width, 10);
            indicatorHeight = a.getDimensionPixelOffset(R.styleable.RulerView_indicator_height, 130);
            tapeWidth = a.getDimensionPixelOffset(R.styleable.RulerView_tape_width, 5);
            minValue = a.getInteger(R.styleable.RulerView_min_value, 20);
            maxValue = a.getInteger(R.styleable.RulerView_max_value, 45);
            numberMarginBottom = a.getDimensionPixelOffset(R.styleable.RulerView_number_margin_bottom, 80);
        } finally {
            a.recycle();
        }
        init();
