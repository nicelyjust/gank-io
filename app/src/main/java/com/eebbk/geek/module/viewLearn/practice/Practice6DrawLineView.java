...
import com.eebbk.geek.module.practice.animate.Point;
import com.eebbk.geek.module.practice.animate.PointSinEvaluator;
...
//
        ...
        animScale.addUpdateListener(animation -> radius = (float) animation.getAnimatedValue());
